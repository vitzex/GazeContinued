        ...
        while (true)
        {
            switch (_state)
            {
                case State.Invisible:
                    ...
                    if (Agent.transform.parent.transform.parent.transform.parent.transform.parent.GetComponentInChildren<Renderer>().isVisible) //only for visible agents
                        SetState(State.Stroll);
